...
- [x] 4.3 Commits en Conventional Commits por grupo de tareas completado; merge a `main` cuando el change esté verificado.
- [x] 4.4 `openspec archive driver-experience-visual-refresh` al cerrar.
